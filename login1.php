		...
		<div align="center">
			...
			?>
					<div class="alert alert-error">
						<font size="5"> Please Login First..</font>
					</div>
			<?php	 }
			}
			//else{ echo "hi";}
			...
			<div class=" well login">
				<form class="form-signin " method="post" action="login.php">
					...
					<table class="table" style="margin-bottom:4px;">
						...
						<tr>
							<td style="border-top:0px;"><label> Email Id</label></td>
							<td style="border-top:0px;"> <input type="email" name="user" class="input-block-level" placeholder="Username"></td>
						</tr>
						<tr>
